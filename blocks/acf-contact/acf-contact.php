    ...
    <div class="container grid grid-cols-1 lg:grid-cols-2">
        <div class="col-span-1 flex flex-col lg:mt-[-155px]">
            ...
            <div class="flex flex-row">
                ...
                <div>   
                    <a href="tel:<?php the_field('telefoon');?>" class="font-poppins font-light text-black text-14 lg:text-15 leading-24"><?php the_field('telefoon');?></a>
                </div>
            </div>
            <div class="flex flex-row">
                <div class="w-[115px]">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24"><?php the_field('whatsapp');?></p>
                </div>
            </div>
            <div class="w-[115px] h-[1px] bg-[#F18700] my-[25px]"></div>
            <div class="flex flex-row">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24"><a href="mailto:<?php the_field('e-mail');?>"><?php the_field('e-mail');?></a></p>
                </div>
            </div>
            <div class="w-[115px] h-[1px] bg-[#F18700] my-[25px]"></div>
            <div class="flex flex-row mb-1">

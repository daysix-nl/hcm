    ...
    <div class="container grid grid-cols-1 lg:grid-cols-2">
        <div class="col-span-1 flex flex-col lg:mt-[-155px]">
            <div class="flex flex-row mb-1">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">Energieweg 20</p>
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">3641 RT Mijdrecht</p>
                </div>
            </div>
            ...
            <div class="flex flex-row">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">Postbus 292</p>
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">3640 AG Mijdrecht</p>
                </div>
            </div>
            ...
            <div class="flex flex-row">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">0297 230 570</p>
                </div>
            </div>
            <div class="flex flex-row">
                <div class="w-[115px]">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">06 - onbekend</p>
                </div>
            </div>
            <div class="w-[115px] h-[1px] bg-[#F18700] my-[25px]"></div>
            <div class="flex flex-row">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24"><a href="mailto:welkom@handlingcompany.nl">welkom@handlingcompany.nl</a></p>
                </div>
            </div>
            <div class="w-[115px] h-[1px] bg-[#F18700] my-[25px]"></div>
            <div class="flex flex-row mb-1">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">Rabobank Rijn en Veenstromen</p>
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">NL98 RABO 0369 6152 39</p>
                </div>
            </div>
            <div class="flex flex-row">
                <div class="w-[115px]">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">Utrecht 30191667</p>
                </div>
            </div>
            <div class="flex flex-row">
                <div class="w-[115px]">
                ...
                <div>   
                    <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">NL 8200.74.378.B01</p>
                </div>
            </div>
        </div>
        <div style="-webkit-filter: grayscale(75%);
filter: grayscale(100%);" class="col-span-1 overflow-hidden lg:mt-[-50px] hidden lg:flex">
            <iframe class="mt-[-120px]" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2445.2597699615612!2d4.879997112841088!3d52.202326659583036!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c675b12e9e299b%3A0xd81c6a9caca5213f!2sHandling%20Company%20B.V.!5e0!3m2!1snl!2snl!4v1703336257302!5m2!1snl!2snl" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
</section>
...
<section class="bg-[#F0F0F0] pt-6 lg:pt-5 pb-8 lg:pb-7">
    <div class="container">
        ...
        <div class="flex space-x-[25px] lg:space-x-[15px]">
            <div class="w-9 h-9 lg:w-[110px] lg:h-[110px] bg-white rounded-md">
                
            </div>
            <div>
                 <h4 class="font-raleway font-bold text-black text-14 lg:text-15 leading-24 mb-[5px">Jurgen Blom</h4>
                 <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24">Functie omschrijving of tel?</p>
                 <p class="font-poppins font-light text-black text-14 lg:text-15 leading-24 mb-[5px]">NL 8200.74.378.B01</p>
                 <a href="">
